 ...
 */
public class Accessories extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.accessories, container, false);
        return layout;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mRefresh = ((SwipeRefreshLayout) layout.findViewById(R.id.accessories_refresh));
        mList = ((ListView) layout.findViewById(R.id.accessories_list));
