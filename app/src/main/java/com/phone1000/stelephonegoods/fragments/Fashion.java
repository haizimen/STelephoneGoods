 ...
 */
public class Fashion extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.fashion, container, false);
        return layout;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mRefresh = ((SwipeRefreshLayout) layout.findViewById(R.id.fashion_refresh));
        mList = ((ListView) layout.findViewById(R.id.fashion_list));
