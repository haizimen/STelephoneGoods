 ...
 */
public class Beauty extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.beauty, container, false);
        return layout;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mRefresh = ((SwipeRefreshLayout) layout.findViewById(R.id.beauty_refresh));
        mList = ((ListView) layout.findViewById(R.id.beauty_list));
